...
namespace AcademyPopcorn
{
    public class Engine
    {
        ...
        private void AddRacket(GameObject obj)
        {
            ...
            this.allObjects.RemoveAll(x => x is Racket); //TASK 03
        ...
        public virtual void Run()
        {
            while (true)
            {
                ...
                System.Threading.Thread.Sleep(this.sleep); //TASK 02
