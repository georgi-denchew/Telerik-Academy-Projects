...
var ninjaPlayerDrawer = Class.create(
    {
        init: function ()
        {
            var self = this;
            this.imgStill = new Image();
            this.imgStillLoaded = false;
            this.imgStill.onload = function ()
            {
                self.imgStillLoaded = true;
            };
            this.imgStill.src = "images/ninja-normal.png";

            this.imgRightStepOne = new Image();
            this.imgRightStepOneLoaded = false;
            this.imgRightStepOne.onload = function () {
                self.imgRightStepOneLoaded = true;
            };
            this.imgRightStepOne.src = "images/ninja-walk-right-1.png";

            this.imgRightStepTwo = new Image();
            this.imgRightStepTwoLoaded = false;
            this.imgRightStepTwo.onload = function () {
                self.imgRightStepTwoLoaded = true;
            };
            this.imgRightStepTwo.src = "images/ninja-walk-right-2.png";


            this.imgLeftStepOne = new Image();
            this.imgLeftStepOneLoaded = false;
            this.imgLeftStepOne.onload = function () {
                self.imgLeftStepOneLoaded = true;
            };
            this.imgLeftStepOne.src = "images/ninja-walk-left-1.png";

            this.imgLeftStepTwo = new Image();
            this.imgLeftStepTwoLoaded = false;
            this.imgLeftStepTwo.onload = function () {
                self.imgLeftStepTwoLoaded = true;
            };
            this.imgLeftStepTwo.src = "images/ninja-walk-left-2.png";


            this.imgJump = new Image();
            this.imgJumpLoaded = false;
            this.imgJump.onload = function () {
                self.imgJumpLoaded = true;
            };
            this.imgJump.src = "images/ninja-jump-up.png";


            this.imgJumpRight = new Image();
            this.imgJumpRightLoaded = false;
            this.imgJumpRight.onload = function () {
                self.imgJumpRightLoaded = true;
            };
            this.imgJumpRight.src = "images/ninja-jump-right.png";

            this.imgJumpLeft = new Image();
            this.imgJumpLeftLoaded = false;
            this.imgJumpLeft.onload = function () {
                self.imgJumpLeftLoaded = true;
            };
            this.imgJumpLeft.src = "images/ninja-jump-left.png";

        },

        drawStill: function (x, y, ctx)
        {
            if (this.imgStillLoaded)
            {
                ctx.drawImage(this.imgStill, x, y,84, 108);
            }
        },

        drawRightStepOne: function (x, y, ctx)
        {
            if (this.imgRightStepOneLoaded)
            {
                ctx.drawImage(this.imgRightStepOne, x, y, 84, 108);
            }
        },
        drawRightStepTwo: function (x, y, ctx) {
            if (this.imgRightStepTwoLoaded)
            {
                ctx.drawImage(this.imgRightStepTwo, x, y, 84, 108);
            }
        },

        drawLeftStepOne: function (x, y, ctx)
        {
            if (this.imgLeftStepOneLoaded) {
                ctx.drawImage(this.imgLeftStepOne, x, y, 84, 108);
            }

        },
        drawLeftStepTwo: function (x, y, ctx) {
            if (this.imgLeftStepTwoLoaded) {
                ctx.drawImage(this.imgLeftStepTwo, x, y, 84, 108);
            }
        ...
        drawJump: function (x, y, ctx) {
            if (this.imgJumpLoaded) {
                ctx.drawImage(this.imgJump, x, y, 84, 108);
            }
        },


        drawJumpLeft: function (x, y, ctx) {
            if (this.imgJumpLeftLoaded) {
                ctx.drawImage(this.imgJumpLeft, x, y, 84, 108);
            }
        },

        drawJumpRight: function (x, y, ctx) {
            if (this.imgJumpRightLoaded) {
                ctx.drawImage(this.imgJumpRight, x, y, 84, 108);
            }
        }
    });

ninjaPlayerDrawer.inherit(playerDrawer);
