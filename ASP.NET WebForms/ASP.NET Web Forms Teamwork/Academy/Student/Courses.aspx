...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderStudent" runat="server">
    ...
    <asp:GridView ID="GridViewStudentCourses" runat="server"
        SelectMethod="GridViewStudentCourses_GetData"
        ...
        DataKeyNames="Id"
        PageSize="5"
        OnSelectedIndexChanged="GridViewStudentCourses_SelectedIndexChanged"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="Description" ControlStyle-Width="370px">
                <ItemTemplate>
